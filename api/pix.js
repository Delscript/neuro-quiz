...
module.exports = async (req, res) => {
    ...
    // Suas chaves estão 100% seguras aqui no servidor
    ...
    try {
        ...
        // SALVANDO O LEAD E O PACOTE DE RESPOSTAS NA MESMA TABELA
        const { error } = await supabase
            ...
            .insert({
                ...
                txid: cobranca.txid,
                status_pagamento: 'aguardando', // <-- A VÍRGULA QUE FALTAVA ESTÁ AQUI
                respostas: body.respostas || [] // <-- A COLUNA NOVA
            });
